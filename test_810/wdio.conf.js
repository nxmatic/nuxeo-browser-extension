exports.config = {
    ...
    screenshotPath: './test_810/screenshots/',
    //
    ...
    cucumberOpts: {
        require: ['./test_810/features/step_definitions/*.js'],        // <string[]> (file/dir) require files before executing features
