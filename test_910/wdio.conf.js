exports.config = {
    ...
    screenshotPath: './test_910/screenshots/',
    //
    ...
    cucumberOpts: {
        require: ['./test_910/features/step_definitions/*.js'],        // <string[]> (file/dir) require files before executing features
